...
cython_targets = ["modulator_kernel_cc", "add_cyclic_prefix_cc", "resource_mapper_kernel_cc", "receiver_kernel_cc", "detect_frame_energy_kernel_cl", "auto_cross_corr_multicarrier_sync_cc"]
